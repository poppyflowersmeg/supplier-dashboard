  ...
  sorted.forEach(s => {
    ...
    card.innerHTML = `
      ...
      <div class="card-actions">
        <button class="btn btn-ghost btn-sm" data-edit-supplier="${s.id}" style="flex:1;cursor:not-allowed;pointer-events:all" disabled>✏️ Edit</button>
      </div>
    `;
  ...
  filtered.forEach(item => {
    ...
    row.innerHTML = `
      ...
      <td><div class="actions-cell">
        <button class="btn-icon" data-edit-item="${item.id}" title="Edit" disabled style="cursor:not-allowed;pointer-events:all">
